...
HD_PWD='D:/vivado_code/project_8/project_8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log openmips_min_sopc_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source openmips_min_sopc_tb.tcl
